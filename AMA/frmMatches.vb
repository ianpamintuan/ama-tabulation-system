            ...
            Try
                ...
                If dbReader.HasRows = True Then
                    ...
                    While dbReader.Read
                        ...
                        .Items(index).SubItems.Add(dbReader.Item("a_assists").ToString)
                        .Items(index).SubItems.Add(dbReader.Item("b_assists").ToString)
                        .Items(index).SubItems.Add(dbReader.Item("a_steals").ToString)
                        .Items(index).SubItems.Add(dbReader.Item("b_steals").ToString)
